    ...
    public void onCommand() {
        ...
        switch (e.getAuthor().getId()) {
            case "125857288807251968": //me
                if (Schedule.PIONEER_HALL.canGo(TimeZone.getTimeZone("GMT-6"), hours)) {
                    sendMessage("yes!");
                } else {
                    sendMessage("no.");
                }
            ...
            case "235275443941539840": //da-CoUGH i mean Satan
                if (Schedule.DLG_COMMONS.canGo(TimeZone.getTimeZone("GMT-8"), hours)) {
                    if (Schedule.CARRILLO_COMMONS.canGo(TimeZone.getTimeZone("GMT-8"), hours)) {
                ...
                } else if (Schedule.CARRILLO_COMMONS.canGo(TimeZone.getTimeZone("GMT-8"), hours)) {
