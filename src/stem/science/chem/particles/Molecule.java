...
public class Molecule extends ArrayList<Molecule>
        implements MolecularIdentity, Polyatomic {
    ...
    public int getProtons() {
        return summate(MolecularIdentity::getProtons); }
    public int getNeutrons() {
        return summate(MolecularIdentity::getNeutrons); }
    public int getElectrons() {
        return summate(MolecularIdentity::getElectrons); }
    public int getCharge() {
        return summate(MolecularIdentity::getCharge); }
    public int getAtomicMass() {
        return summate(MolecularIdentity::getAtomicMass); }
    public boolean isIon() {
        return summate(MolecularIdentity::getCharge)!=0; }
